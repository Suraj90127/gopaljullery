...
import img1 from '../assets/f6af91b4d16d6fe2b06584a240d04426_360x.webp';
...
const BabyEvil = () => {
  ...
  return (
    <div className="w-full md:w-[90%] lg:w-[80%] mx-auto px-4 py-8">
      <h1 className="text-3xl font-semibold text-center mb-8">Baby's Evil Eye Charms</h1>
